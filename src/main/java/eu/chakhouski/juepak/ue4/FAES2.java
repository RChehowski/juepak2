...
public class FAES2
{
    ...
    private int TEST_ENCRYPTION = 0;
    private int AES_KEYBITS = 256;

    private int KEYLENGTH(int keybits) { return ( ( keybits ) / 8 ); }
    private int RKLENGTH( int keybits ) { return ( ( keybits ) / 8 + 28 ); }
    private int NROUNDS( int keybits ) { return ( ( keybits ) / 32 + 6 ); }
    ...
    private static int GETU32(byte[] plaintext)
    {
        return
        (((plaintext)[0] << 24) ^
        ((plaintext)[1] << 16) ^
...
//     */
//    static int rijndaelSetupEncrypt(int[] rk, byte[] key, int keybits )
//    {
//        int i = 0;
//        int temp;
//
