...
public class FAES
{
     ...
     */
    public static byte[] DecryptData(byte[] Contents, int NumBytes, byte[] KeyBytes, int KeyOffset, int NumKeyBytes)
    {
        ...
        try {
            ...
            final byte[] bytes = AES256Cipher.doFinal(Contents, 0, NumBytes);
