...
public class UE4Deserializer
{
     ...
     *
     * @param b A buffer to read to.
     * @return Read boolean.
     */
    public static boolean ReadBoolean(ByteBuffer b)
    {
        setLittleEndian(b);
        return Bool.BOOL(b.get());
    }
    ...
    // 2 byte
    /**
     * Reads a single 2-byte character from the buffer.
     *
     * @param b A buffer to read to.
    ...
    // 4 byte
    /**
     * Reads a single 4-bytes integer from the buffer.
     *
     * @param b A buffer to read to.
     * @return Read integer.
     */
    ...
    /**
     * Reads a single 4-bytes float from the buffer.
     *
     * @param b A buffer to read to.
     * @return Read float.
     */
    ...
    // 8 byte
    /**
     * Reads a single 8-bytes long from the buffer.
     *
     * @param b A buffer to read to.
     * @return Read long.
     */
    ...
    /**
     * Reads a single 8-bytes double from the buffer.
     *
     * @param b A buffer to read to.
     * @return Read double.
     */
